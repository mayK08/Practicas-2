        ...
        <div class="auth-content">
            <div class="container-fluid">
                <div class="row g-0">
                    ...
                    <div class="col-md-5">
                        <div class="auth-form">
                            <h3 class="text-uppercase text-white"><span class="mdi mdi-lock-reset"></span> Nueva Contraseña</h3>
                                ...
                                <div class="my-3">
                                    <div class="form-floating outline outline-white">
                                        <input type="email"
                                            ...
                                            placeholder="Ingresa tu correo electrónico" name="email" value="{{ $email ?? old('email') }}" required
                                            autofocus />
